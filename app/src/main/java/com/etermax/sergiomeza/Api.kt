...
//    ?api_key=436f1bbafb897b0ae3a6f38a65b9a9f8&format=json&nojsoncallback=1&method=flickr.photos.getRecent&extras=date_upload,url_o,owner_name,description
    @GET("?api_key=436f1bbafb897b0ae3a6f38a65b9a9f8&format=json&nojsoncallback=1&method=flickr.photos.getRecent&extras=date_upload,url_o,owner_name,description,url_m,url_s")
